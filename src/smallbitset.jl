...
MapStyle(::Type{SmallBitSet}, ::Type{<:AbstractOneTo{T}}) where T = iffasttypes(StrictStyle(), T)
MapStyle(::Type{SmallBitSet{U}}, ::Type{<:AbstractOneTo{T}}) where {U,T} = iffasttypes(StrictStyle(), U, T)
