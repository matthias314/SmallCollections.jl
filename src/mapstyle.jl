...
MapStyle(::Fix1{typeof(<), U}, ::Type{T}) where {T, U <: Unsigned} = iffasttypes(StrictStyle(), T, U)
MapStyle(::Fix2{typeof(>), U}, ::Type{T}) where {T, U <: Unsigned} = iffasttypes(StrictStyle(), T, U)
